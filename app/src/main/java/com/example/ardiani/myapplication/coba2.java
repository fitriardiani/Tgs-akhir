...
public class coba2 extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,SearchView.OnQueryTextListener{
    ...
    public static final String url_data = "http://192.168.1.26/record/data_pemilik.php";
    public static final String url_cari = "http://192.168.1.26/record/cari_pemilik.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.ardiani.myapplication.coba2.this, daftarTag.class);
                com.example.ardiani.myapplication.coba2.this.startActivity(intent);
            }
        });

        adapter = new com.example.ardiani.myapplication.adapter.Adapter_pemilik(com.example.ardiani.myapplication.coba2.this, listData);
    ...
    private void callData() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_data, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(com.example.ardiani.myapplication.coba2.this, error.getMessage(), Toast.LENGTH_LONG).show();
                swipe.setRefreshing(false);
            }
        });
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(coba2.this);
